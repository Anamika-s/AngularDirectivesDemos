...
@Component({
  selector: 'app-search-main-comp',
  templateUrl: './search-main-comp.component.html',
  styleUrls: ['./search-main-comp.component.css']
})
export class SearchMainCompComponent implements OnInit {
  students: any[]; 
  constructor() { }
